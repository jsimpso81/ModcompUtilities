...
1001	CONTINUE
C
CJAS	CALL ASSIGN(1,'TEXT.TXT')
      OPEN(1,FILE='ADVENT.TXT')                                         JAS
CJAS	DEFINE FILE 2(FILSIZ,37,U,ASCVAR)
      DEFINE FILE 2(2100,37,U,ASCVAR)                                   JAS
	ASCVAR = 1
	LINUSE=1
	TRVS=1
	CLSSES=1
...
CJAS1005	FORMAT(I4,36A2)
1005  FORMAT(I6,36A2)                                                   JAS
D     TYPE 9999,LOC,LINES
D9999 FORMAT(' LOC = ',I6,' LINES=',36A2)
CCD     TYPE 9997,ASCVAR
CCD9997 FORMAT(' ASCVAR=',I6)
...
C
C
CJAS1030  READ(1,1031) LOC,J,NEWLOC,TK
1030  READ(1,1032) LOC,J,NEWLOC,TK                                      JAS
CJAS1031	FORMAT(99I6)
1032  FORMAT(13I6,/,18X,10I6)                                           JAS
D     TYPE *,' LOC=',LOC,' J=',J,' NEWLOC=',NEWLOC,' TK=',TK    
...
D     TYPE 1044,KTAB(TABNDX),ATAB(TABNDX),A2TAB(TABNDX)
D1044 FORMAT(2X,I6,2X,2A2)
1041	FORMAT(I6,2A2)
...
C
CJAS1050  READ(1,1031)OBJ,J,K
1050  READ(1,1051) OBJ,J,K                                              JAS
1051  FORMAT(3I6)                                                       JAS    
D     TYPE *,' OBJ=',OBJ,' J=',J,' K=',K
...
C
CJAS1060	READ(1,1031)VERB,J
1060  READ(1,1061)VERB,J                                                JAS
1061  FORMAT(2I6)                                                       JAS    
D     TYPE *,' VERB=',VERB,' J=',J
...
C
CJAS1070	READ(1,1031)K,TK
1070  READ(1,1072) K,TK                                                 JAS
1072  FORMAT(11I6,/,6X,10I6)                                            JAS    
D     TYPE *,' K=',K,' TK=',TK
	IF(K.EQ.-1)GOTO 1002
	DO 1071 I=1,20
	LOC=TK(I)
...
C
1080	HNTMAX=0
CJAS1081	READ(1,1031)K,TK
1081  READ(1,1072)K,TK                                                   JAS
D     TYPE *,' K=',K,' TK=',TK
	IF(K.EQ.-1)GOTO 1002
...
C
	...
	CALL VOCAB( 2HFI , 2HSS ,1,FISSURE)
...
C
2     CONTINUE
D     TYPE *,' -- MAIN AT 2 -- NEWLOC=',NEWLOC,' LOC=',LOC,' PANIC=',PANIC 
...
CCC   IF(MOD2(LL,1000).EQ.1.OR.MOD2(LL,1000).EQ.K)GOTO 10
...
C
	...
	J= J.OR.K
      I = I + J                                                         JAS
CJAS1	RND= RAN(I,J) *FLOAT(RANGE)
1     RND= INT( RAN(I) *FLOAT(RANGE))                                   JAS
C
	RETURN
	END
C
