...
void ReportCommError()
{
    ...
    // create error string
    //
    strcpy_s(szMessage, sizeof(szMessage), "ERROR: ");
    strcat_s(szMessage, sizeof(szMessage),fDNS ? "DNS " : "");
    strcat_s(szMessage, sizeof(szMessage), fIOE ? "IOE " : "");
    strcat_s(szMessage, sizeof(szMessage), fOOP ? "OOP " : "");
    strcat_s(szMessage, sizeof(szMessage), fPTO ? "PTO " : "");
    strcat_s(szMessage, sizeof(szMessage), fMODE ? "MODE " : "");
    strcat_s(szMessage, sizeof(szMessage), fBREAK ? "BREAK " : "");
    strcat_s(szMessage, sizeof(szMessage), fFRAME ? "FRAME " : "");
    strcat_s(szMessage, sizeof(szMessage), fRXOVER ? "RXOVER " : "");
    strcat_s(szMessage, sizeof(szMessage), fTXFULL ? "TXFULL " : "");
    strcat_s(szMessage, sizeof(szMessage), fOVERRUN ? "OVERRUN " : "");
    strcat_s(szMessage, sizeof(szMessage), fRXPARITY ? "RXPARITY " : "");
...
void ReportStatusEvent(DWORD dwStatus)
{
    ...
    */
    strcpy_s(szMessage, sizeof(szMessage), "EVENT: ");
    strcat_s(szMessage, sizeof(szMessage), fCTS ? "CTS " : "");
    strcat_s(szMessage, sizeof(szMessage), fDSR ? "DSR " : "");
    strcat_s(szMessage, sizeof(szMessage), fERR ? "ERR " : "");
    strcat_s(szMessage, sizeof(szMessage), fRING ? "RING " : "");
    strcat_s(szMessage, sizeof(szMessage), fRLSD ? "RLSD " : "");
    strcat_s(szMessage, sizeof(szMessage), fBREAK ? "BREAK " : "");
    strcat_s(szMessage, sizeof(szMessage), fRXFLAG ? "RXFLAG " : "");
    strcat_s(szMessage, sizeof(szMessage), fRXCHAR ? "RXCHAR " : "");
    strcat_s(szMessage, sizeof(szMessage), fTXEMPTY ? "TXEMPTY " : "");
    ...
    */
    if (dwStatus == 0x0000)
        strcat_s(szMessage, sizeof(szMessage), "NULL");
