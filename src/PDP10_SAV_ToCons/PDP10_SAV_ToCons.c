// PDP10_SAV_ToCONS.c : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, char* argv[]) {
    ...
    /* -------- annouce our program  */
    printf(";-- PDP10_SAV_ToCONS - Convert SAV executable file to console load commands.\n");
    ...
    if (argc > 0) {
        ...
        for (j = 0; j < argc; j++) {
            ...
            if (strcmp(argv[j], "-h") == 0 || strcmp(argv[j], "-?") == 0) {
                printf("\nPDP10_SAV_ToCONS - Convert SAV executable file to console load commands.\n\n");
