...
Public Class ThreePosSwitchOrange
    ...
    ''' <returns></returns>
    '<Category("Data"),
    '    Description("The current value of this switch."),
    '    Browsable(True)>
    ...
    ''' <returns></returns>
    <Category("Behaviour"),
        Description("The value is forced true."),
        Browsable(True)>
    ...
    ''' <returns></returns>
    <Category("Behaviour"),
        Description("The control is allowed to be latched."),
        Browsable(True)>
