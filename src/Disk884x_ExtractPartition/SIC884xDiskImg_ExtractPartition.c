// SIC884xDiskImg_ExtractPartition.c : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, char* argv[]) {
    ...
    /* -------- annouce our program  */
    printf("\nSIC884xDiskImg_ExtractPartition - Extract partition file from an SIC 884x disk image\n");
    ...
    if (have_image_name && have_partition_name) {
        ...
        extract_sic_884x_disk_partition(image_name, partition_name, starting_sector, sector_count, sector_per_track, geom);
    }
    else {
