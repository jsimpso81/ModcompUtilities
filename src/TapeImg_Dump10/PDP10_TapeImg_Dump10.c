// TapeImg_Dump10.c : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main(int argc, char* argv[]) {
    ...
    /* -------- annouce our program  */
    printf("\nTapeImg_Dump10 - Dump PDP-10 36 bit records from a tape image in readable format.\n");
    ...
    if (argc > 0) {
        ...
        if (have_file_name) {
            PDP10_TapeImg_dump10_records(filename, swap_bytes);
        }
    }
    exit(0);
}
