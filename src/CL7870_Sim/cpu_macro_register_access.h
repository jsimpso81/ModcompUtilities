...
#define GET_REGISTER_VALUE_TRIPLE( TREG )  (SIMJ_U64)( \
							( ( cpu_register.reg64[TREG] >> 16 ) & (SIMJ_U64)0x00000000ffff0000 ) | \
							( ( cpu_register.reg64[TREG] << 16 ) & (SIMJ_U64)0x0000ffff00000000 ) | \
							( ( cpu_register.reg64[TREG] << 48 ) & (SIMJ_U64)0xffff000000000000 ))


#define SET_REGISTER_VALUE_TRIPLE( TREG,TVAL) {\
						cpu_register.reg64[TREG] = (SIMJ_U64)( \
							( ( (SIMJ_U64)TVAL >> 48 ) & (SIMJ_U64)0x000000000000ffff ) | \
							( ( (SIMJ_U64)TVAL >> 16 ) & (SIMJ_U64)0x00000000ffff0000 ) | \
							( ( (SIMJ_U64)TVAL << 16 ) & (SIMJ_U64)0x0000ffff00000000 ) | \
							( cpu_register.reg64[TREG] & (SIMJ_U64)0xffff000000000000 )); \
					}
